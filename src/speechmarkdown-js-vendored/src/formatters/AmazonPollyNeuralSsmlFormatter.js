...
var AmazonPollyNeuralSsmlFormatter = /** @class */ (function (_super) {
    __extends(AmazonPollyNeuralSsmlFormatter, _super);
    function AmazonPollyNeuralSsmlFormatter(options) {
    ...
    AmazonPollyNeuralSsmlFormatter.prototype.getTextModifierObject = function (ast) {
    ...
    // tslint:disable-next-line: max-func-body-length
    AmazonPollyNeuralSsmlFormatter.prototype.getSectionObject = function (ast) {
    ...
    // tslint:disable-next-line: max-func-body-length
    AmazonPollyNeuralSsmlFormatter.prototype.formatFromAst = function (ast, lines) {
    ...
    return AmazonPollyNeuralSsmlFormatter;
}(SsmlFormatterBase_1.SsmlFormatterBase));
exports.AmazonPollyNeuralSsmlFormatter = AmazonPollyNeuralSsmlFormatter;
//# sourceMappingURL=AmazonPollyNeuralSsmlFormatter.js.map